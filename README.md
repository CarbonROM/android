...
```sh
cd ~/carbon
repo init -u https://github.com/CarbonROM/android.git -b cr-10.0
repo sync -j8
```

Yes, the branch is `cr-10.0`. That's CarbonROM in it's 10th Revision, which is based on Android 12.
